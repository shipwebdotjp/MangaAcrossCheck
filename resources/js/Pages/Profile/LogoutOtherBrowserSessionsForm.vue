    ...
    <jet-action-section>
        ...
        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                ログインしている端末すべてからログアウトすることが出来ます。もしアカウントへの不審なアクセスがある場合はパスワードを変更してください。
            </div>
                    ...
                    <div class="ml-3">
                        ...
                        <div>
                            <div class="text-xs text-gray-500">
                                ...
                                <span class="text-green-500 font-semibold" v-if="session.is_current_device">このデバイス</span>
                                <span v-else>残りアクティブ数 {{ session.last_active }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <jet-dialog-modal :show="confirmingLogout" @close="confirmingLogout = false">
                ...
                <template #content>
                    他のデバイスをログアウトさせるにはパスワードを入力してください。
